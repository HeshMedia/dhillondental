...
export interface ServiceDetail {
  ...
  export const serviceDetails: Record<string, ServiceDetail> = {
    ...
    'smile-makeover': {
      ...
      Sh: "How Veneers Transform Your Smile",
      solutions: [
    ...
    'braces-aligners': {
      ...
      stepH: "Smile Transformation Process",
      steps: [
    ...
    'teeth-whitening': {
      ...
      Sh: "",
      solutions: [],
      stepH: "Smile Brightening Process",
      steps: [
    ...
    'root-canal-treatment': {
      ...
      stepH: "Painless Healing Process",
      steps: [
    ...
    'full-mouth-rehabilitation': {
      ...
      Sh: "Our Comprehensive Solutions",
      solutions: [
      ...
      stepH: "Personalized Smile Restoration",
      steps: [
    ...
    'crowns-bridges': {
      ...
      stepH: "Seamless Smile Restoration",
      steps: [
    ...
    'teeth-extractions': {
      ...
      stepH: "Gentle & Stress-Free Procedure",
      steps: [
    ...
    'pediatric-dentistry': {
      ...
      stepH: "Fun & Stress-Free Dental Care",
      steps: [
