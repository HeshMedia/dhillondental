        ...
        <div className="container grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/about" className="text-white/80 hover:text-white transition-colors">Dcotors</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/services/teeth-whitening" className="text-white/80 hover:text-white transition-colors">Braces and Aligners</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/resources/customer-stories" className="text-white/80 hover:text-white transition-colors">Monday - Sunday 9 : 30 am - 7 : 00 pm</Link></li>
            </ul>
          </div>
        </div>
      </div>
